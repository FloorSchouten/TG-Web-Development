	...
	<div class="supsystic-item supsystic-panel">
		<form id="toeWelcomePageFindUsForm" method="GET">
			...
			<div class="col-3">
				...
				<p><?php printf(__("It's amazing when you boost development with your feedback and ratings. So we create special <a target='_blank' href='%s'>boost page</a> to help you to help us.", GMP_LANG_CODE), 'http://supsystic.com/boost-our-plugins/')?></p>
			</div>

			<div class="col-3">
				<h3><?php _e('Documentation', GMP_LANG_CODE)?>:</h3>
				<p><?php printf(__("Check <a target='_blank' href='%s'>documentation</a> and FAQ section. If you can't solve your problems - <a target='_blank' href='%s'>contact us</a>.", GMP_LANG_CODE), 'http://supsystic.com/product/supsystic-secure/', 'http://supsystic.com/contacts/')?></p>
			</div>
