<div class="supsystic-actions-wrap" style="display: none;">
	...
	<a class="button-table-action" id="deleteMarkerGroup<?php echo $this->marker_group['id']; ?>" href="#" onclick="gmpRemoveMarkerGroupFromTblClick(<?php echo $this->marker_group['id'];?>);">
